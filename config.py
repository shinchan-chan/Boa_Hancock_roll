...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7705038604:AAGc3U7Gycf-vrS947JunrxZ4Rb7UCyvNCw")
...
#Database --⚠️ REQUIRED--
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://adamopytbusiness1:uSswEjo4ZHMGDU8Z@cluster0.gqgmk.mongodb.net/?retryWrites=true&w=majority&appName=@BoaHancockprobot")
DB_NAME = os.environ.get("DATABASE_NAME", "@BoaHancockprobot")

TG_BOT_WORKERS = int(os.environ.get("TG_BOT_WORKERS", "4"))

#Collection of pics for Bot // #Optional but atleast one pic link should be replaced if you don't want predefined links
PICS = (os.environ.get("PICS", "https://ibb.co/sptdRJ5N")).split() #Required
